  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col relative">
        ...
        {imagePreview && (
          <div className="flex-shrink-0 mx-auto">
            <img
              ...
              style={{ maxWidth: '100%', maxHeight: '600px' }}  // Increase the max height
            />
          </div>
        )}
        </div>
                ...
                <table className="table-auto">
                  ...
                  <tbody>
                    {prediction.map((prob, index) => (
                      <tr key={index}>
                        <td className="border px-4 py-2">{conditionLabels[index]}</td>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white flex">
        ...
        {/* Submit Button */}
        <button className="bg-blue-500 mx-4 text-white px-4 py-2 rounded" onClick={handleSubmit}>
          Submit
        </button>
      </div>
    </div>
